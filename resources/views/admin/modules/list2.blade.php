...
<!-- Mirrored from coderthemes.com/highdmin/layouts/extended-sweetalerts.html by HTTrack Website Copier/3.x [XR&CO'2014], Tue, 10 Jun 2025 13:35:10 GMT -->
<head>
    <meta charset="utf-8" />
    <title>Sweet Alert 2 | Highdmin - Responsive Bootstrap 5 Admin Dashboard</title>
        ...
        <div class="page-container topbar-menu">
            <div class="d-flex align-items-center gap-2">
                ...
                <div class="topbar-item d-none d-md-flex">
                    ...
                    <div>
                        <h4 class="page-title fs-18 fw-bold mb-0">Sweet Alert 2</h4>
                        <ol class="breadcrumb m-0 mt-1 py-0">
                            <li class="breadcrumb-item"><a href="javascript: void(0);">Highdmin</a></li>
                            <li class="breadcrumb-item active">Extended UI</li>
                        </ol>
                    </div>
...
<!-- Sweet alert demo js-->
<script src="{{asset('admin/assets/js/components/extended-sweetalerts.js')}}"></script>

</body>


<!-- Mirrored from coderthemes.com/highdmin/layouts/extended-sweetalerts.html by HTTrack Website Copier/3.x [XR&CO'2014], Tue, 10 Jun 2025 13:35:13 GMT -->
</html>
